...
Approval.prototype = {
	...
	getData: function(userID,pageNum,pageSize){
		var self = this;
		$.ajax({
		    url: getRoothPath+'/ddExpenses/expenseInfo/mySponsoredList',
		    data: { 
		        "userID": userID, //用户ID
...
$(function() {
	...
	if (sessionTouchData_mySponser != null 
		&& sessionTouchData_mySponser != "null" 
		&& pageNum_mySponser != null 
		&& pageNum_mySponser != "null"
		&& dataCount_mySponser != null
		&& dataCount_mySponser != "null") {
